...
% %% running FSCNN
% rho = 1.2;  kappa = 1.2;    alpha = 0.4;   
% M = size(A1,1);    toler = 1e-3;   maxiter = 500;
% tic; 
...
% %% running FeaMAC
% rho = 1.5;  kappa = 1.6;    alpha = 0.4;   beta = 0.001;
% M = 2000;    toler = 1e-3;   maxiter = 500;
% options = 0; 
% tic; 
% [Z81,~] = LapFLRR_v2(X,alpha,beta,options,M,rho,kappa,maxiter,toler);
% t81=toc;
% % plot(diag(W1)');
...
% acc(i,:)=[PSNR,accuracy1,accuracy2,accuracy3,accuracy4,accuracy5, accuracy6, accuracy7, accuracy8,accuracy81,accuracy9];
% NMI(i,:)=[n1,n2,n3,n4,n5,n6,n7,n8,n81,n9];
% end
