...
% %% running FeaMAC
% rho = 1.5;  kappa = 1.1;    alpha = 0.005;   beta = 2;
% M = 10;    toler = 1e-3;   maxiter = 500;
% options = 0.2; 
% tic; 
